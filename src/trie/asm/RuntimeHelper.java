...
final class RuntimeHelper {
	...
	final static SegmentAllocator CONSTANT_ALLOCATOR = (size, align) -> MemorySegment.allocateNative(size, align, MemorySession.openImplicit());
	...
	static final <Z> Addressable upcallStub(Class<Z> fi, Z z, FunctionDescriptor fdesc, String mtypeDesc, MemorySession scope) {
		try {
